...
Mobile.waitForElementClickable(findTestObject('Object Repository/testcase/android.widget.EditText-verification code'), 0)
...
//Mobile.tap(findTestObject('Object Repository/testcase/android.widget.TextView - (2)'), 0)
//Mobile.tap(findTestObject('Object Repository/testcase/android.widget.TextView - (2)'), 0)
//Mobile.tap(findTestObject('Object Repository/testcase/android.view.ViewGroup (3)'), 0)
