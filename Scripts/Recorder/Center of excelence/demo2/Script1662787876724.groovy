...
Mobile.doubleTap(findTestObject('Object Repository/testcase/android.widget.TextView - UPDATE NOW'), 0)
...
Mobile.sendKeys(findTestObject('Object Repository/testcase/android.widget.EditText'), '592726')

Mobile.tap(findTestObject('Object Repository/testcase/android.widget.TextView - VERIFY'), 0)

Mobile.tap(findTestObject('Object Repository/testcase/android.widget.TextView - CONTINUE'), 0)

//Mobile.tap(findTestObject('Object Repository/testcase/android.widget.TextView - Brigosha Center of Excellence (2)'), 0)

//Mobile.tap(findTestObject('Object Repository/testcase/android.widget.TextView - Next'), 0)

Mobile.tap(findTestObject('Object Repository/testcase/android.widget.TextView - Next'), 0)

Mobile.tap(findTestObject('Object Repository/testcase/android.widget.TextView - (4)'), 0)
