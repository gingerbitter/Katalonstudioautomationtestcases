...
Mobile.scrollToText('Chat with aulas team')

Mobile.tap(findTestObject('Object Repository/testcase/android.widget.TextView - Chat with aulas team'), 0)

Mobile.sendKeys(findTestObject('Object Repository/testcase/android.widget.EditText - Type your question here (2)'), 'Hello')

Mobile.tap(findTestObject('Object Repository/testcase/android.widget.TextView - (46)'), 0)

//Mobile.tap(findTestObject('Object Repository/testcase/android.widget.TextView - (47)'), 0)

//Mobile.tap(findTestObject('Object Repository/testcase/android.widget.TextView - Gallery'), 0)

//Mobile.tap(findTestObject('Object Repository/testcase/android.widget.ImageView (16)'), 0)

Mobile.takeScreenshot('C:\\Users\\PRABHA~1\\AppData\\Local\\Temp\\screenshot6180572743640589720.png')
