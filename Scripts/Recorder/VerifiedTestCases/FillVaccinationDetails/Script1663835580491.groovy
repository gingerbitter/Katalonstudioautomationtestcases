...
Mobile.scrollToText('Covid-19 resources')

Mobile.tap(findTestObject('Object Repository/testcase/android.widget.TextView - Covid-19 resources (1)'), 0)

Mobile.tap(findTestObject('Object Repository/testcase/android.widget.TextView - FIND A VACCINATION CENTER'), 0)
