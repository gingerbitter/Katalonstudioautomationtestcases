...
//Mobile.tap(findTestObject('Object Repository/testcase/android.widget.TextView - (43)'), 0)

//Mobile.hideKeyboard()

//Mobile.tap(findTestObject('Object Repository/testcase/android.widget.TextView - (44)'), 0)
